...
@section('title', 'Tambah Lokasi Patroli')
@section('page_title', 'Tambah Lokasi Patroli')

@section('content')
    <form method="POST" action="{{ route('admin.patrol.checkpoints.store') }}" class="bg-white rounded-lg shadow-sm border border-gray-100 p-4 space-y-4 text-xs max-w-2xl">
        @csrf

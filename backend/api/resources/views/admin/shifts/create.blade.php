        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-4">
            <form action="{{ route('admin.shifts.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:border-slate-900" required placeholder="Contoh: Shift Pagi">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="time" step="1" name="start_time" value="{{ old('start_time') }}" class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:border-slate-900" required>
                    ...
                    <div>
                        ...
                        <input type="time" step="1" name="end_time" value="{{ old('end_time') }}" class="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:border-slate-900" required>
                ...
                <div class="flex justify-end gap-2 pt-2">
                    ...
                    <button type="submit" class="px-4 py-2 bg-slate-900 text-white rounded text-xs hover:bg-slate-800">Simpan</button>
                </div>
            </form>
        </div>
    </div>
